...
2. Property-based / fuzz tests of the XNT accounting invariants (index monotonicity, conservation across fund/settle/claim/forfeit, checkpoint consistency), differential against the `core/` reference model.
